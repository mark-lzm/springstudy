...
public class ValidateCodeController {
    ...
    @GetMapping("/{codeType}")
    public void getValidateCode(@PathVariable String codeType, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletRequestBindingException {
